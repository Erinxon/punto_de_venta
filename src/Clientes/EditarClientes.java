...
public class EditarClientes extends javax.swing.JDialog {
    ...
    public void mostrarDatos(int idCliente){
        try{
            ...
            ResultSet result;
            result = instrucion.executeQuery("select nombre,apellido ,direccion from clientes\n" +
            ...
            while(result.next()){
                ...
                this.TextDireccion.setText(result.getString("direccion")); 
    ...
    private void initComponents() {
        ...
        btnEditar = new RSMaterialComponent.RSButtonMaterialOne();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(!nombre.equals("") && !apellido.equals("") && !direccion.equals("")){
            ...
            cliente.editarCliente(1,nombre, apellido, direccion);
            JOptionPane.showMessageDialog(null,"Cliente editado correctamente","Registro Exitoso",JOptionPane.INFORMATION_MESSAGE); 
        }else{
    ...
    private RSMaterialComponent.RSButtonMaterialOne btnEditar;
